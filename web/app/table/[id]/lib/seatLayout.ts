...
export function ringPosForRel(rel: number): RingPos | null {
  switch (rel) {
    ...
    case 3: return 'tr';
    case 4: return 'mr';
    default: return null; // rel 0 = you, rendered separately
  }
}
...
export const RING_COORDS: Record<RingPos, { style: React.CSSProperties; cardSide: 'left' | 'right' }> = {
...
export function collectAnchorPct(rel: number): { left: number; top: number } {
  switch (rel) {
    case 0: return { left: 50, top: 86 }; // you (bottom center)
    case 1: return { left: 14, top: 60 }; // ml
    case 2: return { left: 18, top: 18 }; // tl
    case 3: return { left: 82, top: 18 }; // tr
    case 4: return { left: 86, top: 60 }; // mr

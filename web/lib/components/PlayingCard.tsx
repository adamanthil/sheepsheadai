  ...
  return (
    ...
    >
      <div className={cardStyles.topSection}>
        <div
          className={`${cardStyles.rankTop} ${cardStyles[sizeClass as "small" | "normal" | "big"]}`}
        >
          {rank}
        </div>
        <div
          className={`${cardStyles.suitTopLeft} ${cardStyles[sizeClass as "small" | "normal" | "big"]}`}
        >
          {suitSymbol(suit)}
        </div>
      </div>
      <div
        className={`${cardStyles.suitCenter} ${cardStyles[sizeClass as "small" | "normal" | "big"]}`}
      >
        {suitSymbol(suit)}
      </div>
      <div
        className={`${cardStyles.rankBottom} ${cardStyles[sizeClass as "small" | "normal" | "big"]}`}
      >
        {rank}
      </div>
    </div>

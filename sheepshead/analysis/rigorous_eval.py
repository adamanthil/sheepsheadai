...
class CandidateReport:
    ...
    # per (deal, hero_seat) scores and leaster flags, for conditional reads
    raw_score: Optional[np.ndarray] = None
    raw_leaster: Optional[np.ndarray] = None

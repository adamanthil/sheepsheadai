...
function HomePage({ viewport, navigate, theme }) {
  ...
  return (
    ...
    >
      {isDesktop ? (
        <HomeDesktop navigate={navigate} theme={theme} />
      ) : (
        <HomeMobile navigate={navigate} theme={theme} />
      )}
    </div>
  );
}
...
// Thick-thin rule on top, "what this is" line left, three small cards set INTO
    ...
    <div>
      ...
      <div
        style={{
          ...
          alignItems: "center",
          gap: compact ? 10 : 24,
          padding: compact ? "9px 0 7px" : "12px 0 10px",
        }}
      >
        <div
          className="ss-overline"
          style={{ fontSize: compact ? 8.5 : 11, whiteSpace: "nowrap" }}
        >
          {compact ? "Card Room" : "The Card Room"}
        </div>
        <div
          style={{
            display: "flex",
          ...
          aria-hidden="true"
        >
          <div style={{ transform: "rotate(-7deg) translateY(1px)" }}>
            <PlayingCard rank="Q" suit="C" w={cardW} />
          </div>
          <div
            style={{ transform: "rotate(0deg) translateY(-1px)", zIndex: 1 }}
          >
            <PlayingCard rank="J" suit="D" w={cardW} />
          </div>
          <div style={{ transform: "rotate(7deg) translateY(1px)" }}>
            <PlayingCard rank="A" suit="H" w={cardW} />
          </div>
        </div>
        <div
          className="ss-overline"
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          <button
            ...
            onClick={() => navigate && navigate("howto")}
          >
            How to play →
          </button>
          <span
        ...
        >
          ...
          >
            <div>
              <label className="ss-overline" style={{ fontSize: 10 }}>
                Your name
              </label>
          ...
          >
            <button
              className="ss-btn ss-btn--accent ss-btn--lg"
              onClick={() => navigate && navigate("waiting")}
            >
              Create table →
            </button>
            <span
      ...
      >
        <div className="ss-head-rule" style={{ paddingTop: 14 }}>
          ...
          >
            <h2 className="ss-display" style={{ fontSize: 40, margin: 0 }}>
              The Lobby
            </h2>
            <div className="ss-overline">
              {LOBBY_TABLES.length} tables · live
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div className="ss-overline" style={{ textAlign: "right" }}>
            Action
          </div>
        </div>
...
function HomeMobile({ navigate, theme }) {
  return (
    ...
    >
      ...
      <div>
        <div className="ss-overline" style={{ marginBottom: 8, fontSize: 9 }}>
          Start a table
        </div>
        <div
          style={{
        ...
        >
          <div>
            <label className="ss-overline" style={{ fontSize: 9 }}>
              Your name
            </label>
            <input
              className="ss-input"
              defaultValue="Andrew"
              style={{ fontSize: 18, paddingBottom: 4 }}
            />
          </div>
          <div>
            <label className="ss-overline" style={{ fontSize: 9 }}>
      ...
      <div>
        ...
        >
          <h2
            className="ss-display"
            style={{ fontSize: 24, margin: 0, whiteSpace: "nowrap" }}
          >
            The Lobby
          </h2>
          <div
            ...
            return (
              ...
              >
                ...
                <div>
                  {playing ? (
                    <span
                      className="ss-badge ss-badge--quiet"
                      style={{ fontSize: 9 }}
                    >
                      In play
                    </span>
